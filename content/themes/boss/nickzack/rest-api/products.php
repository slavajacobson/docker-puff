...
add_action( 'rest_api_init', function () {
  register_rest_route( 'product','/all-products', array(
    'methods' => 'GET',
    'callback' => 'return_products'
    
  ) );
} );
//get required fields and dump them into the json file

function return_products($data){
     $data = array();
     $product = get_posts(array('posts_per_page' => -1, 'orderby' => 'date', 'order' => 'asc', 'post_type' => 'product'));
